...
def list_issues(recent: int | None):
...
def create_issue(team: str, project: str | None, title: str, description: str):
    ...
    """
    input_data: dict = {"title": title, "teamId": team, "stateId": backlog_state_id}
    if description:
    ...
    click.echo(f"Created: [{issue['identifier']}] {issue['title']} ({issue['state']['name']})")
...
def list_projects(team: str | None):
